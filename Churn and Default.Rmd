...
This is one of the few statistically significant results observed in the analysis. The only other statistically significant variable was Gender. In model 2, Female account holders are associated 43% decrease in odds of churn, controlling for tenure, Vantage score, occupation and owning one's home. 

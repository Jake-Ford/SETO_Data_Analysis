...
tbl_two <-
  joined %>%
    ...
    tenure < 6 ~ 0,
    tenure > 5 & tenure < 11 ~ 1,
    tenure > 10 & tenure < 15 ~ 2,
    tenure >= 15~ 3
  )) %>%
...
For homes that churned, the tenure was reasonably much shorter than those that did not churn. The below graph shows the average tenure between these two groups, showing that it is almost double for those homes that exhibit continuous subscription. 

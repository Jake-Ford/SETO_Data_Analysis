...
* Label variables and clean variable names
*===============================================================================

//import excel using "$input/Community Solar Priorities Survey (Qualtrics)_June 22, 2021_12.14.xlsx", ///
//	clear sheet("Sheet0") firstrow allstring


import excel "$input/Qualtrics_Community_Data.xlsx", ///
	clear sheet("Community Solar Priorities Surv") firstrow allstring

	*---------------------------------------------------------------------------
	* Drop the first row of the dataset, which are column headers rather 
	* than data
	*---------------------------------------------------------------------------
	...
	* "Surve Data Variable Names.xlsx"
	*---------------------------------------------------------------------------
	
	********************************CAUTION************************************:
	* Make sure none of the variables/questions have changed from the Qualtrics 
	* version of the survey to the community group version of the survey
	****************************************************************************
		...
		label var 	Q_RecaptchaScore 	"Recaptcha Score"
		label var 	Q229_Browser 		 "Q229: User's browser"
		label var 	Q229_Version 		 "Q229: User's browser version"
		label var 	Q229_OperatingSystem "Q229: User's operating system"
		label var 	Q229_Resolution		 "Q229: User's browser resolution"
		...
		********UPDATED 6/24/2021*******
		label var 	Q227_FirstClick 	"Q227: Timing: First click (Community solar preferences 3)"
		label var 	Q227_LastClick 		"Q227: Timing: Last click (Community solar preferences 3)"
		label var 	Q227_PageSubmit 	"Q227: Timing: Page submit (Community solar preferences 3)"
		label var 	Q227_ClickCount 	"Q227: Timing: Click count (Community solar preferences 3)"
		...
		********************************
		...
		label var 	Q76_FirstClick		"Q76: Timing: First click (Community solar preferences 4)"
		label var 	Q76_LastClick		"Q76: Timing: Last click (Community solar preferences 4)"
		label var 	Q76_PageSubmit		"Q76: Timing: Page submit (Community solar preferences 4)"
		label var 	Q76_ClickCount		"Q76: Timing: Click count (Community solar preferences 4)"
		...
		********UPDATED 6/24/2021*******
		label var 	Q228_FirstClick 	"Q228: Timing: First click (Community solar preferences 5)"
		label var 	Q228_LastClick 		"Q228: Timing: Last click (Community solar preferences 5)"
		label var 	Q228_PageSubmit 	"Q228: Timing: Page submit (Community solar preferences 5)"
		label var 	Q228_ClickCount 	"Q228: Timing: Click count (Community solar preferences 5)"
		...
		********************************
		...
		label var 	Q77_FirstClick		"Q77: Timing: First click (Community solar preferences 6)"
		label var 	Q77_LastClick		"Q77: Timing: Last click (Community solar preferences 6)"
		label var 	Q77_PageSubmit		"Q77: Timing: Page submit (Community solar preferences 6)"
		label var 	Q77_ClickCount		"Q77: Timing: Click count (Community solar preferences 6)"
		...
		label var 	Q78_FirstClick		"Q78: Timing: First click (Community solar preferences 7)"
		label var 	Q78_LastClick		"Q78: Timing: Last click (Community solar preferences 7)"
		label var 	Q78_PageSubmit		"Q78: Timing: Page submit (Community solar preferences 7)"
		label var 	Q78_ClickCount		"Q78: Timing: Click count (Community solar preferences 7)"
		...
		label var 	Q79_FirstClick		"Q79: Timing: First click (Community solar preferences 8)"
		label var 	Q79_LastClick		"Q79: Timing: Last click (Community solar preferences 8)"
		label var 	Q79_PageSubmit		"Q79: Timing: Page submit (Community solar preferences 8)"
		label var 	Q79_ClickCount		"Q79: Timing: Click count (Community solar preferences 8)"
		...
		label var 	state				"Respondent state"
		label var 	Q_TotalDuration		"Total duration"
		label var	FL_11_DO			"Contract review order"  //JF has to be manually concatenated
		
		** DID WE DELETE THIS QUESTION?
	...
	*---------------------------------------------------------------------------
		...
		rename 	Q_RecaptchaScore 	 recaptcha_score
		rename 	Q229_Browser 		 browser 
		rename 	Q229_Version 		 browser_version
		rename 	Q229_OperatingSystem operating_system
		rename 	Q229_Resolution		 browser_resolution
		...
		********UPDATED 6/24/2021*******
		rename 	Q227_FirstClick		time_first_click_cspref3 
		rename 	Q227_LastClick		time_last_click_cspref3 
		rename 	Q227_PageSubmit		time_page_submit_cspref3 
		rename 	Q227_ClickCount		time_click_count_cspref3
		rename 	Q226_1 				utility_small_fee
		rename 	Q226_2 				single_bill 
		rename  Q226_3 				prefer_solar 
		********************************
		
		rename	Q76_FirstClick		time_first_click_cspref4
		rename	Q76_LastClick		time_last_click_cspref4
		rename	Q76_PageSubmit		time_page_submit_cspref4
		rename	Q76_ClickCount		time_click_count_cspref4
		...
		********UPDATED 6/24/2021*******
		rename 	Q228_FirstClick 	time_first_click_cspref5
		rename 	Q228_LastClick 		time_last_click_cspref5
		rename 	Q228_PageSubmit 	time_page_submit_cspref5
		rename 	Q228_ClickCount 	time_click_count_cspref5
		rename 	Q225_1				credit_score 
		rename 	Q225_2				confident_program
		rename 	Q225_3				covid19
		*rename	Q58_5				program_know_someone ** DID WE DELETE THIS QUESTION?
		********************************

		rename	Q77_FirstClick		time_first_click_cspref6
		rename	Q77_LastClick		time_last_click_cspref6
		rename	Q77_PageSubmit		time_page_submit_cspref6
		rename	Q77_ClickCount		time_click_count_cspref6
		...
		rename	Q78_FirstClick		time_first_click_cspref7
		rename	Q78_LastClick		time_last_click_cspref7
		rename	Q78_PageSubmit		time_page_submit_cspref7
		rename	Q78_ClickCount		time_click_count_cspref7
		...
		rename	Q79_FirstClick		time_first_click_cspref8
		rename	Q79_LastClick		time_last_click_cspref8
		rename	Q79_PageSubmit		time_page_submit_cspref8
		rename	Q79_ClickCount		time_click_count_cspref8
		...
		rename 	Q_TotalDuration		total_duration
	
	*---------------------------------------------------------------------------
	* Drop additional variables included in the Qualtrics output that we don't 
	* need or don't know what they are
	*---------------------------------------------------------------------------
		drop opp
		drop RISN
		drop rid
	...
	*---------------------------------------------------------------------------
		...
		save "$temp/survey_data_clean_names_qualtrics.dta", replace

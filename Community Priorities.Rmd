...
### Table 2: Models 1-4 Odds Ratios
```{stata echo=FALSE}
...
### Table 4: Models 5-8 Odds Ratios
```{stata echo=FALSE}
...
maybe only include significant variables from primary in the secondary?
...
esttab, label                                ///
     title(Logistic Regression on Contract Adoption)       ///
     nonumbers mtitles("Model 5" "Model 6" "Model 7" ) 

...
chas_name <- paste(input_folder, "3. Churn and Default/input/Central Hudson Preliminary Analysis/040/Table11.csv", sep="")

chas_data_11 <- read.csv(paste(input_folder, "3. Churn and Default/input/Central Hudson Preliminary Analysis/040/Table11.csv", sep=""))%>%
...
pie_data_bars <- reshape::melt(pie_data, id.var="Income")

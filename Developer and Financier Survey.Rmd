...
ggplot(data = long_data, aes(x = Factors , y =pct_long , fill = reorder(Importance, -order),
                                     text=paste("Factor", Factors, "\nValue:", pct_long))) + 
...
ggplot(data = long_data, aes(x = Factors , y =pct_long , fill = reorder(Importance, -order),
  ...
  ylab("")+ 
  theme_minimal() +
  ggtitle("Factors that Influence decision to include LMI in projects")
...
ggplot(data = long_data, aes(x = Factors , y =pct_long , fill = reorder(Importance, -order),
  ...
  ylab("")+ 
  theme_minimal() +
  ggtitle("Factors to Fill out CS Projects Quickly")
